...
namespace MG.EventBus.Startup
{
	public static class EventBusDependencyExtensions
	{
		...
		{
			retry.Interval(5, TimeSpan.FromMinutes(5));
		...
		public static Container RegisterHandleKsiEventConsumerDependencies(this Container container, EventBusSettings settings)
		{
